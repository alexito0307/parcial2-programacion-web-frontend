  ...
  return (
    <section className="grid lg:grid-cols-3 grid-cols-1 border-b-2">
      <div className="flex flex-col items-center justify-center p-5 lg:p-10">
        <img src="images/magnifying-glass.webp" alt="MagniFying Glass" className="w-1/4"/>
      ...
      <div className="flex flex-col items-center justify-center p-10">
        <img src="images/coffee-plant-vertical.webp" alt="Coffee Plant Vertical" className="w-1/4"/>
      ...
      <div className="flex flex-col items-center justify-center p-10">
        <img src="images/books.webp" alt="Books" className="w-1/4"/>
